...
public class NotLabelableSourceCount extends MLESuffStat {

	public NotLabelableSourceCount(FeatureManager iman, NonterminalTransformer filt) {
		super(iman, filt);
	}
	...
	public String getKey(ScoreableRule rule) throws RuleException {
		return MyUtils.untokenize(SuffStatMapper.DELIM,
				filt.transformAntecedentNonterm(rule.srcAntecedents));
	}
}
