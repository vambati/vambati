...
public class SyntacticCategSourceTargetCount extends MLESuffStat {

	public SyntacticCategSourceTargetCount(FeatureManager iman, NonterminalTransformer filt) {
		super(iman, filt);
	}
