...
import utils.MyNLP;
import ml.*;
import ml.mira.MIRALearner;
import ml.utils.*;

public class QAParamTrainer_MIRA {
	public static void main(String[] args) throws Exception {
       ...
       { 
		...
		MIRALearner m = new MIRALearner(qdecoder);
		m.train(questionsData,answerRefData, num_iter,qlistTestFile);
