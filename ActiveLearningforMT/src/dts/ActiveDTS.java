...
public class ActiveDTS extends RandDTS
{
	public ActiveDTS(String trainFile,String testFile)
	{
		super(trainFile,testFile);
	}
	public ActiveDTS(Instances trainData, Instances testData) 
	{
	...
	public static void main(String args[]) throws Exception{
		...
		ActiveDTS dc = new ActiveDTS(args[0],args[1]);
