...
import crowdsource.validate.Validator;
...
public class HIT {
	...
	public void computeAgreement(Validator validator){
	...
	// Compare one with other and award a 'vote' 
	// Hypothesis can match against itself and 'vote' for itself
	public void computeAgreement(Validator validator,Hashtable<String,Oracle> oracles){
		AGREEMENT = new Hashtable<String, Double>(); 
	...
	// Compare one with other and award a 'vote' 
	// Hypothesis can match against itself and 'vote' for itself
	public void computeWeightedAgreement(Validator validator,Hashtable<String,Oracle> oracles){
		AGREEMENT = new Hashtable<String, Double>(); 
