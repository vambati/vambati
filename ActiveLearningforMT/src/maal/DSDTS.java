 ...
 */
public class DSDTS extends DTSUncertaintyQuerySelector {
	
	// For purposes of diversity , also load Labeled data
	LDS L = null;
	DDWDS densityQS = null; 
	
	public DSDTS(String ngFile,LDS l,String mosesFile,int tag,String src,String tgt){
	...
	public double computeScore(Entry ex) {
		...
		double beta = 1;
		e.score = uscore / (double) e.sLength; // Normalization 
		return uscore; 
