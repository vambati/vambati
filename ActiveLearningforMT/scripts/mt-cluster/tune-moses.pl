...
my $transfer = "/home/vamshi/myscripts/moses";

my $extracthyps = "/home/vamshi/code/scripts/mt-cluster/moses2hyps.pl";

my $optimize_nbest = "/home/vamshi/tools/OptimizeNBest.070608.O64";
...
sub createIniFile {
	...
	open(IFILE, ">$opt_wd/$opt_prefix.$current_round.ini") or die("Couldn't create $opt_wd/$opt_prefix.$current_round.ini\n");
...
HEAD
	...
	return "$opt_wd/$opt_prefix.$current_round.ini";
}
