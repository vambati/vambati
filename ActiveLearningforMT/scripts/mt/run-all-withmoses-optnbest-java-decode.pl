...
{
# Decoding based  (Runs moses with previous best parameters and creates the output file )
system("perl /afs/cs/user/vamshi/workspace-eclipse/ActiveLearningforMT/scripts/model/viterbi-mosesrun.pl  $prev_iter $s $t >& runlog.$prev_iter"); 
