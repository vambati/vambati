...
# Sentence.cgi
# Program to translate Single Sentence
...
if($nm)
{
	...
	print '</div></b>'.
		...
		'		<a href="/cgi-bin/sentence.cgi">SentenceLevel</a>'.
		'	</div>'.
		'	<!--/TitleFmt-->'.
		'		<div id="wikipage">'.
		'		<!--PageText-->'.
		...
		'					<h1 style="font-size:large" align="center">Sentence Level Translation</h1>'.
		'	<img border="0" src="/Translations.jpg" width="304" height="169" left="20px" align="right" position="relative"/>'.
		'					<i>(English >> Hindi)</i>'.
		'					<br><br>'.
		'					<div id="outerdiv">'.
		'						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>English Sentence:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.
		'						<input id="engsent" name="engsent" type="text" size="50">&nbsp;&nbsp;<input id="translateid" name="translateid" value="Translate" type="button" onclick="onTranslateClick()">'.
		'						<br><br>'.
		...
		'<script type="text/javascript" src="/scripts/otpei_source.js"></script>'.
		'</body>'.
		'</html>';
}
else
